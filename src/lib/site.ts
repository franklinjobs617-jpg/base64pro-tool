...
export const games = [
  {
    ...
    description: 'Paralives is an upcoming May 25, 2026 Steam Early Access life simulation game for PC and Mac, with a $39.99 launch price, offline single-player play, gridless building, Paramaker character creation, Steam Workshop sharing, and roadmap features like pets, cars, and town editing planned during Early Access.',
