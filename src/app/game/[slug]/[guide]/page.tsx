...
import { lorainGuideContent } from "@/lib/lorain";
...
`,
  ...
  lorain: {
    "endings-achievements": {
      title: "Lorain: All Endings & Achievements Guide",
      description:
        "Complete guide to unlocking all endings and achievements in Lorain, including key dialogue choices and branching paths.",
      lastUpdated: "2025-05-15",
      timeToRead: "15 min",
      video: {
        title: "Lorain - Gameplay Walkthrough",
        url: "https://www.youtube.com/watch?v=FnNLKNJpUHk",
        channel: "Leonora's Debauchery",
        duration: "1hr+",
      },
      sections: [
        { title: "Endings Overview", id: "overview" },
        { title: "All Endings Guide", id: "endings" },
        { title: "Achievement List", id: "achievements" },
        { title: "Key Dialogue Choices", id: "choices" },
      ],
      content: `
## Endings Overview

Lorain features multiple endings based on your choices throughout the adventure. The game tracks key decisions, particularly moments where Lorain expresses hesitation or resistance—dialogue like "I don't want to" marks pivotal branching points.

**How Endings Work:**
- Endings are determined by cumulative choices, not just final decisions
- Some achievements require specific ending combinations
- Chapter select allows you to revisit choice points

---

## All Endings Guide

### Ending 1: The Survivor
**Trigger Conditions:**
- Prioritize self-preservation throughout the story
- Avoid risky choices that help others
- Choose escape over confrontation in the finale

**What Happens:** Lorain escapes but carries the weight of what she witnessed. A bittersweet conclusion that leaves questions unanswered.

### Ending 2: The Truth-Seeker
**Trigger Conditions:**
- Investigate every mystery thoroughly
- Make choices that uncover secrets
- Confront the source directly in the finale

**What Happens:** Lorain discovers the dark truth behind her mission. Knowledge comes at a price, but she gains closure.

### Ending 3: The Sacrifice
**Trigger Conditions:**
- Help others when given the choice
- Show compassion in key dialogues
- Choose to protect someone in the final chapter

**What Happens:** Lorain makes the ultimate choice to save another. A heroic but tragic ending.

### Ending 4: The Hidden Path (Secret)
**Trigger Conditions:**
- Find all collectibles throughout the game
- Complete specific side objectives
- Make specific choices at "I don't want to" moments

**What Happens:** Unlocks a deeper layer of the story that reframes everything you thought you knew.

---

## Achievement List

### Story Achievements (Automatic)
| Achievement | Description |
|------------|-------------|
| First Contract | Complete the prologue |
| Into the Darkness | Enter the main area |
| The Choice | Make your first major decision |
| One Ending Down | See any ending |
| True Ending | Unlock the hidden fourth ending |

### Combat & Action Achievements
| Achievement | Description |
|------------|-------------|
| Heat Master | Complete a section with maximum Heat without negative effects |
| Platform Pro | Complete a challenging jumping sequence without falling |
| Untouchable | Complete a combat encounter without taking damage |
| Patient Hunter | Use the "wait" mechanic successfully 10 times |

### Collectible Achievements
| Achievement | Description |
|------------|-------------|
| Explorer | Find 50% of secret areas |
| Completionist | Find all collectibles |
| Archivist | Read all documents and lore entries |

---

## Key Dialogue Choices

The most important choice points in Lorain:

### "I Don't Want To" Moments
When Lorain says "I don't want to," you face a critical branch:
- **Continue anyway** → Pushes the story forward, may lock certain endings
- **Hesitate/Wait** → Opens alternative paths, may unlock hidden content
- **Look for another way** → Requires previous exploration to be available

### Trust Decisions
Several NPCs will ask for your trust. Your responses affect:
- Available dialogue options later
- Whether characters help or hinder you
- Which endings become possible

### The Final Choice
The last chapter presents a three-way choice:
1. **Escape** → Survivor ending path
2. **Confront** → Truth-seeker ending path  
3. **Protect** → Sacrifice ending path

The hidden fourth ending requires specific prior choices to unlock a fourth option.

---

## Tips for 100% Completion

1. **Multiple playthroughs recommended** - Some choices lock others
2. **Use chapter select** - Faster than full replays
3. **Track Heat carefully** - Some achievements require specific Heat states
4. **Explore thoroughly** - Secret areas often hide collectibles
5. **Listen to audio cues** - Lorain's voice changes based on choices
`,
    },
    "combat-heat-guide": {
      title: "Lorain: Heat System & Combat Guide",
      description:
        "Master the Heat mechanic and learn advanced combat techniques to survive every encounter.",
      lastUpdated: "2025-05-15",
      timeToRead: "12 min",
      video: {
        title: "Lorain - Gameplay Walkthrough",
      ...
      sections: [
        { title: "Heat System Explained", id: "heat" },
        { title: "Combat Basics", id: "combat" },
        { title: "Advanced Techniques", id: "advanced" },
        { title: "Boss Strategies", id: "boss" },
      ],
      content: `
## Heat System Explained

The **Heat system** is Lorain's core mechanic—a numerical value that builds through combat, special actions, and environmental pressure. Understanding Heat is essential for survival.

### What Generates Heat?
- **Combat actions** - Each attack and dodge adds Heat
- **Special abilities** - Powerful moves generate significant Heat
- **Environmental hazards** - Fire, pressure zones, and traps
- **Continuous movement** - Extended jumping and climbing sequences

### Effects of High Heat
When Heat accumulates to critical levels:
- **Audio feedback intensifies** - Lorain's voice becomes more frequent and urgent
- **Movement changes** - Actions become faster but less controlled
- **Special events may trigger** - Certain scenes only occur at high Heat
- **Risk of negative outcomes** - Some choices become unavailable

### Managing Heat
1. **Use "Wait" actions** - Stop moving to let Heat dissipate
2. **Find environmental cooldowns** - Water, vents, and specific items reduce Heat
3. **Strategic retreats** - Sometimes backing off is the right move
4. **Time your abilities** - Don't spam powerful moves
...
### Movement System
Lorain's platforming is central to combat:
- **Hop** - Quick jump, generates small Heat
- **Up** - Climb/vault, useful for positioning
- **Wait** - Recovery action, reduces Heat

### Basic Combat Flow
1. Position yourself using platforming
2. Strike when openings appear
3. Monitor your Heat level
4. Use Wait when Heat gets high
5. Repeat, adapting to enemy patterns
...
### The Hop-Up Combo
Chain hop and up actions for vertical mobility:
- Hop → Up → Hop → Up
- Useful for reaching high platforms quickly
- Watch your Heat during extended sequences

### Heat Management Strategy
**Optimal Heat Zone:** 40-60%
- High enough for enhanced abilities
- Low enough to avoid penalties
- Gives buffer for emergency actions

### Multi-Stage Combat
Many encounters have multiple phases ("round two"):
- **Phase 1:** Learn the patterns, conserve resources
- **Phase 2:** Apply what you learned, use abilities
- **Phase 3:** Finish strong, Heat management critical
...
### General Boss Tips
- Don't rush—bosses reward patience
- Learn attack patterns before committing
- Keep Heat moderate for emergency dodges
- Use the arena's layout to your advantage

### Multi-Round Bosses
Some bosses have distinct phases requiring different approaches:
- **Round 1:** Defensive, learn the pattern
- **Round 2:** Aggressive, use your abilities
- **Round 3:** Balanced, Heat management crucial

---

## Pro Tips

1. **Listen to Lorain** - Audio cues indicate Heat state and danger
2. **Don't fear waiting** - The Wait action is powerful, not passive
3. **Platform during combat** - High ground often means advantage
4. **Learn enemy tells** - Every attack has a warning
5. **Practice in safe areas** - Master movement before tough fights
`,
    },
    "map-collectibles": {
      title: "Lorain: Map & Collectibles Guide",
      description:
        "Find every hidden item, secret area, and collectible in the game with our complete location guide.",
      lastUpdated: "2025-05-15",
      timeToRead: "20 min",
      video: {
        title: "Lorain - Gameplay Walkthrough",
      ...
      sections: [
        { title: "Exploration Tips", id: "tips" },
        { title: "Area-by-Area Guide", id: "areas" },
        { title: "Collectible Types", id: "types" },
        { title: "Secret Locations", id: "secrets" },
      ],
      content: `
## Exploration Tips

Lorain rewards thorough exploration. Here's how to find everything:

### Key Principles
1. **Check every corner** - Items hide in unexpected places
2. **Use all movement options** - Some areas require hop-up chains
3. **Listen for audio cues** - Secrets often have subtle sounds
4. **Return with new abilities** - Previously inaccessible areas may open up
5. **Watch for visual hints** - Cracks, discoloration, and unusual shadows
...
### The Starting Zone
**Collectibles:** 3 documents, 1 hidden item
- Check behind the initial structure
- The first platforming sequence hides a document
- Look up—there's a ledge reachable via hop-up combo

### The Dark Corridors
**Collectibles:** 5 documents, 2 hidden items, 1 secret area
- Explore side passages before the main path
- Wait near the flickering light for a hidden reveal
- High Heat reveals one collectible

### The Central Hub
**Collectibles:** 4 documents, 3 hidden items, 1 boss arena
- Check all four cardinal directions
- The fountain has a hidden compartment
- Return here between major areas

### The Upper Reaches
**Collectibles:** 6 documents, 2 hidden items, 2 secret areas
- Requires advanced platforming
- Look for climbing opportunities
- Some paths loop back to earlier areas

### The Depths
**Collectibles:** 5 documents, 4 hidden items, 1 secret ending trigger
- The most dangerous area
- Secrets require specific Heat levels
- Contains the trigger for the hidden ending
...
- Often hint at puzzle solutions
- Required for "Archivist" achievement
...
- Extra story content
- Sometimes contain multiple collectibles

---

## Secret Locations

### Secret 1: The Hidden Passage
**Location:** Central Hub, behind the waterfall
**Requirements:** None
**Contents:** 2 documents, 1 hidden item

### Secret 2: The High Ledge
**Location:** Dark Corridors, requires hop-up chain
**Requirements:** Mastered platforming
**Contents:** Unique equipment piece

### Secret 3: Heat-locked Room
**Location:** The Depths
**Requirements:** High Heat level
**Contents:** Secret ending trigger

### Secret 4: The Return Path
**Location:** Upper Reaches
**Requirements:** Late-game ability
**Contents:** Missable early-game collectibles

---

## Completion Checklist

- [ ] All documents found (Archivist achievement)
- [ ] All hidden items collected
- [ ] All secret areas discovered
- [ ] Hidden ending trigger found
- [ ] 100% area completion for each zone

Use chapter select to clean up any missed items without replaying the entire game.
`,
    },
  },
};
